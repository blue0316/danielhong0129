        ...
        return (
            <Html data-theme='dark'>
                <Head>
                    ...
                    {/* <meta property='og:url' content='https://danielhong00129.vercel.com/'/> */}
                    ...
                    {/* <meta property='twitter:url' content='https://danielhong00129.vercel.com/'/> */}
                    ...
                    {/* <meta property='twitter:image' content='https://danielhong00129.vercel.com/favicon.png'/> */}

                    <link rel='icon' href='/favicon.png' />
                    {/* <link rel='apple-touch-icon' href='https://danielhong00129.vercel.com/favicon.png'/> */}
                    {/* <link rel='manifest' href='https://danielhong00129.vercel.com/manifest.json'/>
                    <link rel='canonical' href='https://danielhong00129.vercel.com' /> */}
                    ...
                    <script
                        ...
                        dangerouslySetInnerHTML={{
                            __html: JSON.stringify({
                                ...
                                // image: 'https://danielhong00129.vercel.com/images/marko.png',
                                jobTitle: 'Full-Stack Developer',
                                // url: 'https://danielhong00129.vercel.com'
                            })
                        }}
                    />
                </Head>
