...
const Home: NextPage = (props: any) => {
    ...
    return (
        <Fragment>
            <Head>
                <title>Daniel Hong &mdash; Full-Stack Developer</title>
            </Head>
                ...
                <header className={styles.homeHeader}>
                    ...
                    <div className={styles.homeHeaderLogs}>
                        <div className={styles.homeHeaderLogsBox}>
                            <span className={styles.homeHeaderLogsBoxNumber}>23+</span>
                            <p className={styles.homeHeaderLogsBoxParagraph}>{t('home:headers.1.customers')}</p>
                        </div>
                        <div className={styles.homeHeaderLogsBox}>
                            <span className={styles.homeHeaderLogsBoxNumber}>42+</span>
