    ...
    return (
        <aside className={classnames(styles.aside, { [styles.asideActive]: asideOpen })}>
            ...
            <div className={styles.asideFooter}>
                <a href='https://www.instagram.com/DanielHong/' target='_blank'>
                    <BsInstagram />
                </a>
                <a href='https://dribbble.com/DanielHong' target='_blank'>
                    <BsDribbble />
                </a>
                ...
                <a href='https://www.linkedin.com/in/marko-markovic-smart/' target='_blank'>
                    <BsLinkedin />
                </a>
            </div>
        </aside>
